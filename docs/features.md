...
| [x] | `--encoding` | 文字エンコーディング指定 (自動検出対応) | v1.2 |
...
| [x] | `std` | 標準偏差 | v1.1 |
| [x] | `median` | 中央値 | v1.2 |
| [x] | `percentile` | パーセンタイル (p25, p75) | v1.2 |
...
| [x] | `--quiet, -q` | 進捗表示抑制 | v1.1 |
| [x] | `--color` | カラー出力制御 (auto/always/never) | v1.2 |
...
| [x] | 進捗バー | 大規模ファイル処理時の進捗表示 | v1.1 |
| [x] | 並列処理 | マルチスレッド集計 (rayon) | v1.2 |
